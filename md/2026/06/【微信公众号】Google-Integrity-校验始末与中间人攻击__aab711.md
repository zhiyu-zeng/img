---
title: 【微信公众号】Google Integrity 校验始末与中间人攻击
source: https://mp.weixin.qq.com/s/u_YfVbY4pXwJe1bcGByUKg
source_host: mp.weixin.qq.com
clip_date: 2026-06-10T18:34:56+08:00
trace_id: bf3e4ad5-90fd-4df1-9641-49c75d9524d2
...
![cover\_image](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/06/693cff40edef2629.jpg)
...
![作者头像](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/06/b1667f51c3e9eeb6.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/06/ec1ffcfe59fa5484.png)
...
![划线引导图](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/06/acfa72d5ca61a6eb.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/06/27b1a63364951b28.png)
...
1.  1\. RootOfTrust（用于校验设备是否已解锁）
    
2.  2\. AttestationApplicationId（用于校验发起密钥认证的 APP 签名）
...
-   • r, s = decode\_ecdsa\_signature(Leaf.signatureValue);
    
-   ecdsa\_verify(Leaf.TBSCertificate, r, s, Attestation Public Key)
    
-   • r, s = decode\_ecdsa\_signature(AttestationsignatureValue);
...
但是当我们拥有一台有 Root 权限并且没有解锁 Bootloader 设备的时候呢？那么这台设备就具备以下两个发起中间人攻击的条件：
