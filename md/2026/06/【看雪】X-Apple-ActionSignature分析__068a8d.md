...
clip_date: 2026-06-16T17:09:12+08:00
trace_id: 746209aa-6f42-45b8-be6c-9d7d9af8b7a1
content_hash: 563d850133c9175ab405c9e143112da448000f19c91b9c107edb99c0bf8c1108
status: summarized
tags:
  - 看雪
series: null
ai_summary: X-Apple-ActionSignature的安全机制极其复杂，采用多层混淆与白盒加密，纯算法还原困难，需借助工具与模拟调用进行分析。
ai_summary_style: key-points
images_status:
  total: 12
  succeeded: 12
  failed_urls: []
notion_page_id: 38175244-d011-81de-9290-d0dc400d5577
---

> 💡 **AI 总结（key-points）**
>
> X-Apple-ActionSignature的安全机制极其复杂，采用多层混淆与白盒加密，纯算法还原困难，需借助工具与模拟调用进行分析。
> 
> - **混淆技术：** 算法核心使用BR间接跳转混淆，辅以MBA混淆、代码平坦化，且堆栈内存地址均加密，大幅增加静态分析难度。
> - **分析方法：** 采用真机trace工具GumTrace抓取执行流程，再利用IDAPython脚本patch地址以去除BR混淆，显著提升分析效率。
> - **加密数据结构：** 请求签名数据由固定字节、从libCoreFP.so计算的32字节、0x100字节运算数据、从signSapSetup响应计算的字节及填充部分构成。
> - **核心算法：** 涉及基于梅森旋转算法（MT19937）的伪随机数生成，并深度使用白盒加密与查表技术，最终通过与body明文、证书交换数据进行多轮混合运算生成签名。
> - **实现建议：** 由于算法复杂，纯算还原耗时巨大，推荐使用unidbg等工具模拟调用以完成协议破解。
...
[GumTrace](https://bbs.kanxue.com/elink@98cK9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6D9K9h3c8G2L8X3N6&6L8$3!0G2i4K6u0r3c8%4g2E0g2s2u0S2j5$3g2Q4x3X3g2Y4K9i4b7%60.): 真机trace工具

[trace-ui](https://bbs.kanxue.com/elink@535K9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6A6L8h3Z5H3x3i4W2Q4x3V1k6@1M7X3q4U0k6g2\)9J5k6s2g2A6i4K6u0W2k6$3W2@1): trace日志分析工具
