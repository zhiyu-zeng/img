---
title: 【看雪】jnilog + gozinject：免 Frida 的 Android JNI 全表实时追踪（fork 时刻注入 + VMA 隐藏）
source: https://bbs.kanxue.com/thread-291624.htm
source_host: bbs.kanxue.com
clip_date: 2026-06-16T17:14:28+08:00
trace_id: 2e297889-7397-4c34-aac5-3594cb55381d
content_hash: 825676a2aad6b3bb20cee0e9a14e05f738ca762b3e0e8be88905045d9c958a2f
status: summarized
tags:
  - 看雪
series: null
ai_summary: jnilog 和 gozinject 通过 fork 时刻注入和 VMA 隐藏，实现免 Frida 的 Android JNI 全表实时追踪，特别适用于加固应用。
ai_summary_style: key-points
images_status:
  total: 4
  succeeded: 4
  failed_urls: []
notion_page_id: 38175244-d011-81fd-bd3f-d9efbab8b3b9
---

> 💡 **AI 总结（key-points）**
>
> jnilog 和 gozinject 通过 fork 时刻注入和 VMA 隐藏，实现免 Frida 的 Android JNI 全表实时追踪，特别适用于加固应用。
> 
> - **工具角色：** jnilog 是 JNI 追踪载荷，hook 全部 228 个 JNI 函数表项；gozinject 是注入器，在应用进程 fork 时刻加载，无需 ptrace 或调试器 attach。
> - **工作原理：** jnilog 使用 Go 和 C 实现，替换 JNI 表并记录调用；gozinject 通过字节级 patch zygote 的 libandroid_runtime.so，在 fork 时注入载荷。
> - **追踪输出：** 实时记录 JNI 调用，带类型和符号化信息，如类名、字符串值、字段ID等，有助于逆向分析加固应用的行为。
> - **隐藏特性：** gozinject 可从链接器链表中摘除载荷并隐藏 VMA，对抗反篡改扫描；jnilog 的 C 核心避免使用 libc 调用，减少被 hook 的风险。
> - **配置构建：** 支持 JSON 配置文件控制追踪范围，可通过 xmake 构建工具并使用命令行注入。

**翻译声明** ：本文由英文原文经 AI 翻译整理，可能存在表述或技术细节上的偏差。如有歧义，请以 [英文原文](https://bbs.kanxue.com/elink@eb6K9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6m8M7Y4y4&6L8r3E0Q4x3V1k6B7L8X3W2D9L8$3M7%60.) 及源码为准。
...
| 工具  | 角色  | 版本与形态 |
| --- | --- | --- |
| [`jnilog`](https://bbs.kanxue.com/elink@bcbK9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6m8M7Y4y4&6L8r3E0Q4x3V1k6B7L8X3W2D9L8$3M7%60.) | JNI 追踪载荷 | `1.1.0` ；Android/arm64 cgo 共享库；hook 全部 228 个 JNI 表项 |
| [`gozinject`](https://bbs.kanxue.com/elink@ca4K9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6m8M7Y4y4&6L8r3E0Q4x3V1k6Y4L8%4A6A6L8X3A6W2j5%4b7%60.) | 加载器/注入器 | `1.0.0` ；Android/arm64 Go 注入器；root，zygote fork 时刻加载 |
...
**代码：** [github.com/Arsylk/jnilog](https://bbs.kanxue.com/elink@ac7K9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6m8M7Y4y4&6L8r3E0Q4x3V1k6B7L8X3W2D9L8$3M7%60.) ｜ **加载器：** [github.com/Arsylk/gozinject](https://bbs.kanxue.com/elink@f39K9s2c8@1M7s2y4Q4x3@1q4Q4x3V1k6Q4x3V1k6Y4K9i4c8Z5N6h3u0Q4x3X3g2U0L8$3#2Q4x3V1k6m8M7Y4y4&6L8r3E0Q4x3V1k6Y4L8%4A6A6L8X3A6W2j5%4b7%60.)
