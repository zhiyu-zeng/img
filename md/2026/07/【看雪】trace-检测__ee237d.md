---
title: 【看雪】trace 检测
source: https://bbs.kanxue.com/thread-292176.htm
source_host: bbs.kanxue.com
clip_date: 2026-07-26T20:26:03+08:00
trace_id: dd76a7cc-fd39-4f4c-a7d2-05ccd84b5669
content_hash: b0a6f9bbe0af3b6306e1701d7ce701dbc65a495300df2f667988c3272f6ec345
status: summarized
tags:
  - 看雪
  - Android逆向
...
ai_summary: 基于 Linux 内核信号上下文观察 Physical PC，提出异步采样和 BRK 异常两种方案，以检测动态二进制插桩并保护算法不被 trace 日志轻易还原。
ai_summary_style: key-points
images_status:
  total: 3
  succeeded: 3
  failed_urls: []
notion_page_id: 3a975244-d011-81f0-a533-e8d83d1bad83
ioc: null
---

> 💡 **AI 总结（key-points）**
>
> 基于 Linux 内核信号上下文观察 Physical PC，提出异步采样和 BRK 异常两种方案，以检测动态二进制插桩并保护算法不被 trace 日志轻易还原。
> 
> - **检测动机：** AI 能力提升使得 trace 日志还原算法成本极低，需通过检测 DBI 增加逆向难度。
> - **异步 PC 采样：** 通过 watchdog 线程发送 SIGUSR2 信号，采集 8 次 PC 样本，判断是否落在预定义的探针窗口外。
> - **BRK 异常上下文：** 主动执行 BRK 指令触发 SIGTRAP，比较内核信号上下文中的 PC 与预期地址，检测不一致。
> - **实现方式：** 使用宏 DBI_TRACE_DETECTED() 插入目标函数，汇总两种方案结果，一旦检测到强证据即进程级标记为检测状态。
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/1bc9071f02e1dfd0.webp)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/2ebdb2655c888da1.webp)
...
**效果展示：**  
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/9cac3f3c850b406f.gif)
...
- [app-release.apk](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/attach/2026/07/2614a440cbdab09c.apk) （29.50kb，0次下载）
