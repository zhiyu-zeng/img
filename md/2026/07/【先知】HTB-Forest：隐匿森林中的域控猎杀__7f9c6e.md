---
title: 【先知】HTB-Forest：隐匿森林中的域控猎杀
source: https://xz.aliyun.com/news/92556
source_host: xz.aliyun.com
clip_date: 2026-07-29T00:42:25+08:00
trace_id: 96f5f30e-88a6-44e0-bd8f-7e3b35cac0e4
content_hash: eadf9216b26be4044792516a141688ffbf3e4afd6fb739de6b8f08a4b1277c48
status: synced
tags:
  - 先知
  - 协议分析
...
series: null
feed_source: null
ai_summary: 通过AS-REP Roasting获取域用户凭据，结合BloodHound滥用组权限链条实现DCSync攻击，最终获得域管理员哈希。
ai_summary_style: key-points
images_status:
  total: 10
  succeeded: 10
  failed_urls: []
notion_page_id: 3ab75244-d011-813a-ba49-fc8ffbae5b67
ioc:
  cves: []
  cwes: []
  hashes:
...
> 💡 **AI 总结（key-points）**
>
> 通过AS-REP Roasting获取域用户凭据，结合BloodHound滥用组权限链条实现DCSync攻击，最终获得域管理员哈希。
> 
> - **目标识别：** Nmap发现Windows域控，开放53/88/389/445/5985等典型端口，域名为htb.local，SMB需用户认证。
> - **初始突破：** LDAP匿名枚举出用户列表，AS-REP Roasting发现svc-alfresco未要求预认证，破解其TGT密文得到密码s3rvice，通过WinRM获取Shell。
> - **权限路径：** BloodHound分析显示svc-alfresco对Exchange Windows Permissions组有GenericAll可加成员，该组对域有WriteDacl，可授予DCSync所需复制权限。
> - **域提权：** 利用PowerView将svc-alfresco加入Exchange Windows Permissions组并赋予DCSync，使用secretsdump提取Administrator NT哈希，Pass-the-Hash登录拿到root flag。

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/60e4c85acf5753bf.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/cdea11b1a15adeb0.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/c1b552f1971e5133.png)

AS 会响应“需要预认证”的错误提示。

而对于无需预认证的账户：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/30f094add38f1ace.png)

会成功响应 AS-REP。

`netexec` 就在该响应中，提取了密文信息：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/07d627cf790a6e2d.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/81b6b6246ad5153a.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/cd899c14833b0873.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/f7efc53d53e4422a.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/07c67ef56c0d9d98.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/d908e800fd1faef3.png)
