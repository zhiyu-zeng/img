---
title: 【微信】网安原创文章推荐【2026/7/27】
source: https://mp.weixin.qq.com/s/dIdavNNMbbPSq0h6QBECdw
source_host: mp.weixin.qq.com
clip_date: 2026-07-28T08:45:34+08:00
trace_id: ff6b36fb-ab21-42f7-9951-23345a7990b3
content_hash: e42c51152db5dc8d72476ed3de033ba0634ed74b3f502fc5331d12776c557cb4
status: summarized
tags:
  - 微信
  - 漏洞分析
...
ai_summary: 多个高危漏洞和攻击方法被集中披露，涵盖Fastjson反序列化、Active Directory提权及Redis远程代码执行，安全防御需重点关注升级和配置加固。
ai_summary_style: key-points
images_status:
  total: 15
  succeeded: 15
  failed_urls: []
notion_page_id: 3ab75244-d011-81c3-8bb5-f78cc5dc56a0
ioc:
  cves:
    - CVE-2026-16723
    - CVE-2026-25589
...
> 💡 **AI 总结（key-points）**
>
> 多个高危漏洞和攻击方法被集中披露，涵盖Fastjson反序列化、Active Directory提权及Redis远程代码执行，安全防御需重点关注升级和配置加固。
> 
> - **Fastjson攻击链：** Fastjson 1.2.83及Fastjson2默认配置下，即使关闭AutoType或开启safeMode，仍可通过构造包含`@type`的恶意JSON触发远程代码执行，攻击利用ASM生成非法类名与Spring Boot FatJar环境完成利用。
> - **AD CS提权风险：** CVE-2026-54121（Certighost）影响Active Directory证书服务，普通域用户可提升至域管理员权限，CVSS 8.8，已有公开PoC。
> - **Redis认证后RCE：** Redis模块RedisBloom存在堆溢出（CVE-2026-25589）和Streams双重释放（QVD-2026-44936），认证后攻击者可root权限接管服务器，影响Redis 6.2.22/7.4.9/8.6.4等版本。
> - **内网横向移动集锦：** 汇总多种横向手法，包括RDP、IPC$共享、PTH/PTK/PTT攻击、WMIexec、WinRM及DCOM等，强调不同上下文下的权限差异与工具运用。
> - **ModHeader插件后门：** 原ModHeader浏览器插件因包含恶意后门被下架，出现去后门代码的替代版，提醒仅限授权测试使用。

**洞见网安** *2026年7月28日 08:26*
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/993b3e72d5bcf8e4.jpg)
...
内网渗透 远程桌面 远程控制软件 IPC$ 共享 PTH攻击 PTK攻击 PTT攻击 WMIexec WinRM SMB协议 命令执行
...
网络安全 逆向工程 免杀技术 沙箱检测 代码分析 C# 编程 Windows 安全
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/b519267fde27d41b.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/76453108af629a4e.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/a23e00ea1e41f39b.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/ad5e41e14430fa4e.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/7818c7552690c428.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/4880f2ecfc984db7.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/a94fcd910ff6eae8.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/3a2bdf8bfba2178e.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/ae400acba154ba18.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/6ead8e136eef4c46.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/b14c7a14ee45b894.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/ca85c2b5224d6f6d.jpg)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/1d42e8bd7786e901.jpg)
