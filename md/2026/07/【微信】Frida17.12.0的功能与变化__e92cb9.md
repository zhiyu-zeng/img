...
clip_date: 2026-07-14T00:35:22+08:00
trace_id: 60ded5b8-30fd-4e46-90fb-6395ce9a105c
content_hash: e04239c7663ba4afcc268acc0c0c6275dfbe5e3cfd1ac4f160832e681f900dab
status: summarized
tags:
  - 微信
  - Frida
...
series: null
feed_source: null
ai_summary: Frida 17.12.0 为脚本开发者引入了函数范围定位与控制流图分析能力，同时优化了 Linux 注入的稳定性和多个内部细节。
ai_summary_style: key-points
images_status:
  total: 3
  succeeded: 0
  failed_urls:
    - https://wechat2rss.xlab.app/img-proxy/?k=023efc04&u=https%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz_jpg%2FSq4BUsrXeT94hPSDdKumJvkC4e26KKZc1SN0QwibQXnylqSMLr5sd7Fyicklos13kRuicPEGW0ZjwmxXQ48CSMW2alo7PKQowlLibYCarC1PttU%2F0%3Fwx_fmt%3Djpeg
    - https://wechat2rss.xlab.app/img-proxy/?k=4c4ccec2&u=https%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz_svg%2FQ3auHgzwzM6RlNFib1bbtdEf0r21NvIe4PjqrcGGic3jHYSLOaIcqPIVyPI4F3TojriceWzB14QFar5s4aiaLmjloMz8HLRvicQB6NHkrKKJj17Tw6BibPU7uEcw%2F640%3Fwx_fmt%3Dsvg%26from%3Dappmsg
    - https://wechat2rss.xlab.app/img-proxy/?k=69e05e8d&u=https%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz_png%2FSq4BUsrXeT9vHaho87lZcLVbOic0SG5psmwywHqCj9tg5iavx9P02pIpSWHKj5O3gGDe4ZY6Jk1uHUvYHgYDunwkQJk5jtPgicrPLcIniacu4Yc%2F640%3Fwx_fmt%3Dpng%26from%3Dappmsg
notion_page_id: 39c75244-d011-811a-a3d4-db66226750e7
ioc: null
---

> 💡 **AI 总结（key-points）**
>
> Frida 17.12.0 为脚本开发者引入了函数范围定位与控制流图分析能力，同时优化了 Linux 注入的稳定性和多个内部细节。
> 
> - **新增静态分析接口：** Gum 和 GumJS 新增 `Process.findFunctionRange()` 和 `ControlFlowGraph` 接口，可在不依赖符号的情况下确定函数边界、分析基本块支配关系与可写入位置。
> - **Linux 注入器优化：** 调整了注入触发点的选择逻辑，包括 eBPF 不可用时的回退方案、扫描线程栈寻找更大函数空间，以及使用实际 bootstrap 大小进行筛选。
> - **关键路径加固：** 修改了触发点的安装与恢复流程（先阻塞相关线程再写入），并更改了 agent 的 `dlopen()` 路径以避免调试器观察不一致问题。
> - **Interceptor 细粒度刷新：** 新增 `gum_interceptor_flush_function()` 和 `gum_interceptor_flush_listener()` 接口，允许按函数或监听器确认相关任务完成。
> - **Windows ARM64 修复：** 修复了 Stalker 和 Exceptor 在 Windows ARM64 平台上的稳定性问题，并补充了相关 CI 任务。

![](⚠️ https://wechat2rss.xlab.app/img-proxy/?k=023efc04&u=https%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz_jpg%2FSq4BUsrXeT94hPSDdKumJvkC4e26KKZc1SN0QwibQXnylqSMLr5sd7Fyicklos13kRuicPEGW0ZjwmxXQ48CSMW2alo7PKQowlLibYCarC1PttU%2F0%3Fwx_fmt%3Djpeg)
...
![](⚠️ https://wechat2rss.xlab.app/img-proxy/?k=4c4ccec2&u=https%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz_svg%2FQ3auHgzwzM6RlNFib1bbtdEf0r21NvIe4PjqrcGGic3jHYSLOaIcqPIVyPI4F3TojriceWzB14QFar5s4aiaLmjloMz8HLRvicQB6NHkrKKJj17Tw6BibPU7uEcw%2F640%3Fwx_fmt%3Dsvg%26from%3Dappmsg)
...
![](⚠️ https://wechat2rss.xlab.app/img-proxy/?k=69e05e8d&u=https%3A%2F%2Fmmbiz.qpic.cn%2Fmmbiz_png%2FSq4BUsrXeT9vHaho87lZcLVbOic0SG5psmwywHqCj9tg5iavx9P02pIpSWHKj5O3gGDe4ZY6Jk1uHUvYHgYDunwkQJk5jtPgicrPLcIniacu4Yc%2F640%3Fwx_fmt%3Dpng%26from%3Dappmsg)
