---
title: 【看雪】Google Integrity 校验始末与中间人攻击
source: https://bbs.kanxue.com/thread-291541.htm
source_host: bbs.kanxue.com
clip_date: 2026-07-09T17:49:19+08:00
trace_id: 7571b37a-9dc0-451f-b2af-0e06f0000466
content_hash: b27e5d38f3bb64d88e34e651acb6b73b6fa3ab72f15ac5d3aab080d9491a5768
status: summarized
tags:
  - 看雪
series: null
feed_source: null
ai_summary: Google Integrity 校验依赖Tee证书链验证设备完整性，但当设备有Root权限且Bootloader未解锁时，可通过中间人攻击伪造证书链，绕过验证。
ai_summary_style: key-points
images_status:
  total: 10
  succeeded: 10
  failed_urls: []
notion_page_id: 39875244-d011-8184-a332-fe9bdb41f7ef
ioc:
  cves: []
  cwes: []
  hashes:
    - 2812ef63dd35e8d8c7cbc6453dbd7961ec5f1e3645d4eae0584dbd383f0ae7ec
    - 5e6af0046b0b9faf744df21648abe4e049c1c7e5c0de06b830e6b784187d7e8d
    - 894ce4844f1b477fa99a4f515de4acaa80121998b19efe3e7faffae6497be163
    - 984470b2b5ceafcdcd705c1a6285bc93ffe420fea2d25d373dcdc3949ac85fda
    - bd5a30d9d722df7e36397b918861aa9084ef9eb54ae31255926e7552e84e4104
    - cedb1cb6dc896ae5ec797348bce9286753c2b38ee71ce0fbe34a9a1248800dfc
    - e47aa4c751f9079c06367ff3814e9bb441c754242e2154929de5067a680a3b4e
  domains: []
  tools: []
  techniques: []
---
...
> 💡 **AI 总结（key-points）**
>
> Google Integrity 校验依赖Tee证书链验证设备完整性，但当设备有Root权限且Bootloader未解锁时，可通过中间人攻击伪造证书链，绕过验证。
> 
> - **Token生成机制：** 客户端请求Integrity Token时，服务端收集设备信息、包名签名等，并通过Key Attestation获取Tee证书链，组装后发送后端进行ECDSA签名验证。
> - **Key Attestation原理：** 证书链由Tee硬件生成，包括根证书、中间证书和叶子证书，后端通过链式签名校验，根证书需Google备案，叶子证书包含设备锁定状态。
> - **漏洞条件：** 设备需拥有Root权限以导出证书链，且Bootloader未解锁以通过设备完整性检查，两个条件同时满足时攻击可行。
> - **攻击实施：** 使用Frida脚本Hook应用，将可信设备（已通过验证）的证书链转发至目标设备，使目标设备通过Google Integrity验证。
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/3c498dfe259f6068.webp)

发起请求时携带了一个 IntegrityTokenRequest 参数，里面主要包含了获取 Token 的必要参数：nonce、cloudProjectNumber。

进入到 this.a.c 函数：

![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/b77b66c16b2d5e16.webp)
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/552485a19b178c7d.webp)

![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/78b943472a8a7600.webp)
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/2ff2d091382b851b.webp)

![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/7885ba210d1deada.webp)
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/66e378f52e53a427.webp)
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/36bf562bf5e1b000.webp)
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/227a4c958176b510.webp)
...
![图片描述](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/328f79d16aafc6fa.webp)
