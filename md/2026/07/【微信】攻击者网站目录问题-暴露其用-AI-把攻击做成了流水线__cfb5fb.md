---
title: 【微信】攻击者网站目录问题 暴露其用 AI 把攻击做成了流水线
source: https://mp.weixin.qq.com/s/fJws6yg8dM-6Hs94u9iRuQ
source_host: mp.weixin.qq.com
clip_date: 2026-07-23T07:44:11+08:00
trace_id: 6ecca427-d7de-4ffc-96a9-52e74c303917
content_hash: d10749775774e501c870a91ede9980bdd02b44c5ade08376ca817e39af8f961f
status: summarized
tags:
  - 微信
  - AI应用
...
ai_summary: 攻击者暴露了一个利用AI构建的、工业化的WebDAV恶意软件交付实验室，其运作模式已类似产品团队快速迭代攻击。
ai_summary_style: key-points
images_status:
  total: 11
  succeeded: 11
  failed_urls: []
notion_page_id: 3a575244-d011-8178-b03f-c591191d0aa8
ioc:
  cves:
    - CVE-2025-24054
    - CVE-2025-33053
...
> 💡 **AI 总结（key-points）**
>
> 攻击者暴露了一个利用AI构建的、工业化的WebDAV恶意软件交付实验室，其运作模式已类似产品团队快速迭代攻击。
> 
> - **WebDAV滥用：** 攻击者利用Windows原生WebDAV协议投递恶意文件，因其是系统功能，易绕过安全检测，成为热门攻击通道。
> - **目录内容：** 公开目录包含1048个文件，涵盖453个LNK钓鱼快捷方式、236个文件名伪装样本、89个加密加载器等，覆盖攻击全链路。
> - **漏洞利用：** 重点测试CVE-2025-33053等高危漏洞，利用.url文件结合iediagcmd.exe等LOLBins执行，有详细文档描述利用逻辑。
> - **AI工业化：** 攻击者使用LLM批量生成测试文档、诱饵和操作手册，并开发“Simba Service”管理面板进行攻击流程的自动化与监控。
> - **操作安全：** 攻击者OPSEC意识差，测试目录完全公开且管理面板使用默认账号密码，导致整个攻击基础设施暴露。

**白帽子** *2026年7月23日 07:27*
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/7f1012e14824bba4.png)
...
![testing-files-subfolders.png](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/94ab709ee9a009ef.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/cc0086deb2b2bf8b.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/efdd702d807366a6.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/5e668f0c271af3d9.png)
...
第二个是名为DlrtyGames 的攻击链，采用了完全不同的DLL sideloading (DLL 侧加载)投递架构。攻击入口是 7-Zip 制作的自解压包 DlrtyGames.exe，解压后会释放两个文件，一个是合法签名的育碧程序Volt_Droid.exe，另一个是恶意的discord-rpc.x64.dll。当用户运行合法程序时，会优先加载同目录下的恶意DLL 文件，完成初始执行。
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/42bab4c005cefb02.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/aff9309f2c3d91ec.png)

![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/bb07f88d81f0afdb.png)

![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/209e76512805af38.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/cab381f295b03c18.png)
