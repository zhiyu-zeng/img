---
title: 【微信】【转】Mythos向左，AiPy往右｜继Mythos之后，他们又发现100多个漏洞
source: https://mp.weixin.qq.com/s/O884mg-JECELA9Wwu6Bb6Q
source_host: mp.weixin.qq.com
clip_date: 2026-07-28T21:40:06+08:00
trace_id: 8cb1a19b-e246-43c0-b5eb-d9554e874b7f
content_hash: 4ddf885fb4c132eba8f5b470775bb09de975bb4b25c8c2c448007509e5f6b667
status: synced
tags:
  - 微信
  - 漏洞分析
...
ai_summary: Anthropic的Mythos模型在漏洞挖掘领域引发关注后，中国安全智能体AiPy团队通过自研方案在同类任务中同样实现了百级漏洞发现，证明大模型结合专家经验的路线已具备规模化漏洞挖掘能力。
ai_summary_style: key-points
images_status:
  total: 2
  succeeded: 2
  failed_urls: []
notion_page_id: 3ab75244-d011-81d9-9330-c71a36e75707
ioc:
  cves:
    - CVE-2026-12293
    - CVE-2026-12996
...
> 💡 **AI 总结（key-points）**
>
> Anthropic的Mythos模型在漏洞挖掘领域引发关注后，中国安全智能体AiPy团队通过自研方案在同类任务中同样实现了百级漏洞发现，证明大模型结合专家经验的路线已具备规模化漏洞挖掘能力。
> 
> - **漏洞挖掘成果：** AiPy团队在已被Mythos高强度扫描过的Firefox等项目中，累计向Mozilla提交111个漏洞，其中9个已获CVE编号并修复，另在NGINX、OpenVPN、macOS等系统中持续发现高危漏洞。
> - **技术路径差异：** AiPy方案不依赖Claude模型，而是在通用大模型基础上叠加内部漏洞专家定制的Harness工程与历史数据，弥补国内模型在安全漏洞泛化理解上的不足。
> - **模型能力差距：** 团队实践表明，国内顶级模型在网络安全场景仍主要依赖代码生成能力泛化，其自主理解漏洞的泛化能力与GPT-5.6 Sol、Mythos等国外模型存在代差，导致效果过度依赖专家工作流。
> - **厂商应对压力：** 大规模漏洞发现给厂商带来巨大处理压力，例如NGINX将多个漏洞合并为一个CVE，并通过简单限制输入长度的方式集中修复，反映出当前响应机制的瓶颈。
> - **团队背景：** AiPy源于知道创宇404实验室，该团队长期深耕漏洞挖掘与AI智能体研发，较早提出“Code is Agent”理念，其专家积累与工程化经验是方案的基础要素。

**黑哥虾撩** *2026年7月28日 21:13*

![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/f8582c684c3b7104.png)
...
![图片](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/07/b64e33e6c7733262.png)
