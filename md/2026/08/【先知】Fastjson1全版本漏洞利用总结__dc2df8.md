---
title: 【先知】Fastjson1全版本漏洞利用总结
source: https://xz.aliyun.com/news/92638
source_host: xz.aliyun.com
clip_date: 2026-08-06T16:51:03+08:00
trace_id: 80afd2a7-c821-42d7-a789-b77cb217492c
content_hash: 659af8e4b09d7255748872eeafc9b4303f1efff3c2fd4d0fbdb1e7bb1625b7f8
status: synced
tags:
  - 先知
  - 漏洞分析
...
ai_summary: Fastjson1各版本（1.2.47/68/80/83）反序列化绕过与利用链的完整梳理，覆盖探测、WAF绕过、常见gadget及写文件RCE落地思路。
ai_summary_style: key-points
images_status:
  total: 62
  succeeded: 62
  failed_urls: []
notion_page_id: 3b475244-d011-8130-83be-f2b3b93dab40
ioc:
  cves:
    - CVE-2022-25845
    - CVE-2026-16723
...
> 💡 **AI 总结（key-points）**
>
> Fastjson1各版本（1.2.47/68/80/83）反序列化绕过与利用链的完整梳理，覆盖探测、WAF绕过、常见gadget及写文件RCE落地思路。
> 
> - **版本绕过核心：** 1.2.47通过`java.lang.Class`的MiscCodec缓存绕过；1.2.48后改为利用`AutoCloseable`等；1.2.68-1.2.80利用`Exception`子类与ThrowableDeserializer的`cast`缓存；1.2.83可借`@JSONType`注解或CVE-2026-16723的`jar:http`/`jar:file`/`http`/`file`协议加载恶意类。
> - **探测手段：** 用AutoType报错、`java.lang.AutoCloseable`、`JSONException`、dnslog区分版本；用`java.lang.Character`报错回显（`can not cast`）探测依赖与classpath；用`com.alibaba.fastjson.support.geo.Feature`（1.2.68引入）判断是否存在期望类。
> - **常用利用链：** JdbcRowSetImpl（JNDI）、BCEL（需dbcp且JDK≤8u251）、C3P0、commons-io任意文件读写、MySQL/PostgreSQL JDBC、groovy出网加载jar、aspectjtools读文件、ognl+io等；写文件后可通过计划任务/sshkey、webshell、覆盖`jre/lib`、写classes+SPI等方式RCE。
> - **WAF绕过：** 支持Unicode/hex编码、`\x`（第二个字符可为任意非hex字符）、`\u`（用Unicode数字冒充hex）、多逗号、`_`/`-`替换、大体积填充及GhostBytes等手段绕过`@type`特征。
> - **配套工具：** FastjsonExpToolkit提供探测/PoC/WAF绕过能力，JNDI-Exp-MCP用于起JNDI服务，payload可用java-chains生成，靶场可参考FastJsonParty。

## 目录

-   [前言](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%89%8D%E8%A8%80)
-   [反序列化流程](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%8F%8D%E5%BA%8F%E5%88%97%E5%8C%96%E6%B5%81%E7%A8%8B)

-   [Fastjson判断](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#fastjson-%E5%88%A4%E6%96%AD)
-   [版本探测](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E7%89%88%E6%9C%AC%E6%8E%A2%E6%B5%8B)
-   [依赖探测](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E4%BE%9D%E8%B5%96%E6%8E%A2%E6%B5%8B)
-   [判断是否存在期望类](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%88%A4%E6%96%AD%E6%98%AF%E5%90%A6%E5%AD%98%E5%9C%A8%E6%9C%9F%E6%9C%9B%E7%B1%BB)

-   [1.2.83](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#1283)

-   [jar:http 利用](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#jarhttp-%E5%88%A9%E7%94%A8)

-   [1.2.47](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#1247)

-   [1.2.48 ~ 1.2.67](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#1248-1267)

-   [绕过分析](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E7%BB%95%E8%BF%87%E5%88%86%E6%9E%90-1)
-   [修复分析](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E4%BF%AE%E5%A4%8D%E5%88%86%E6%9E%90-1)
-   [JDK11 任意写 / 文件清空](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#jdk11-%E4%BB%BB%E6%84%8F%E5%86%99-%E6%96%87%E4%BB%B6%E6%B8%85%E7%A9%BA)

-   [文件复制](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E6%96%87%E4%BB%B6%E5%A4%8D%E5%88%B6)
-   [commons-io 利用](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#commons-io-%E5%88%A9%E7%94%A8)

-   [commons-io 版本差异](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#commons-io-%E7%89%88%E6%9C%AC%E5%B7%AE%E5%BC%82)
-   [io 读文件 / 目录](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io-%E8%AF%BB%E6%96%87%E4%BB%B6-%E7%9B%AE%E5%BD%95)
-   [io1 / io2 写文件（编码后支持二进制）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io1-io2-%E5%86%99%E6%96%87%E4%BB%B6%E7%BC%96%E7%A0%81%E5%90%8E%E6%94%AF%E6%8C%81%E4%BA%8C%E8%BF%9B%E5%88%B6)

-   [解析特性](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E8%A7%A3%E6%9E%90%E7%89%B9%E6%80%A7)

-   [io3 写文件（≈ io1 / io2）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io3-%E5%86%99%E6%96%87%E4%BB%B6-io1-io2)
-   [io4 写文件（支持二进制）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io4-%E5%86%99%E6%96%87%E4%BB%B6%E6%94%AF%E6%8C%81%E4%BA%8C%E8%BF%9B%E5%88%B6)
-   [io5 写文件 / 创建目录（io4 换依赖，能写任意大小文件）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io5-%E5%86%99%E6%96%87%E4%BB%B6-%E5%88%9B%E5%BB%BA%E7%9B%AE%E5%BD%95io4-%E6%8D%A2%E4%BE%9D%E8%B5%96%E8%83%BD%E5%86%99%E4%BB%BB%E6%84%8F%E5%A4%A7%E5%B0%8F%E6%96%87%E4%BB%B6)
-   [io6 写文件（LockableFileWriter，突破 8kb）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io6-%E5%86%99%E6%96%87%E4%BB%B6lockablefilewriter%E7%AA%81%E7%A0%B4-8kb)
-   [io7 写文件（有期望类时套 Currency）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#io7-%E5%86%99%E6%96%87%E4%BB%B6%E6%9C%89%E6%9C%9F%E6%9C%9B%E7%B1%BB%E6%97%B6%E5%A5%97-currency)
-   [ioFinal 写文件（终形态）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#iofinal-%E5%86%99%E6%96%87%E4%BB%B6%E7%BB%88%E5%BD%A2%E6%80%81)

-   [MysqlJdbc](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#mysqljdbc)

-   [出网](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%87%BA%E7%BD%91)
-   [不出网（结合写文件）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E4%B8%8D%E5%87%BA%E7%BD%91%E7%BB%93%E5%90%88%E5%86%99%E6%96%87%E4%BB%B6)

-   [PostgreSql](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#postgresql)

-   [1.2.80](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#1280)

-   [绕过分析](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E7%BB%95%E8%BF%87%E5%88%86%E6%9E%90-2)
-   [修复分析](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E4%BF%AE%E5%A4%8D%E5%88%86%E6%9E%90-2)
-   [jackson+io 读写文件 / 目录](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#jackson-io-%E8%AF%BB%E5%86%99%E6%96%87%E4%BB%B6-%E7%9B%AE%E5%BD%95)
-   [PostgreSql](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#postgresql-1)

-   [jackson 依赖](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#jackson-%E4%BE%9D%E8%B5%96)
-   [jython 依赖](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#jython-%E4%BE%9D%E8%B5%96)

-   [MySqlJDBC](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#mysqljdbc-1)
-   [groovy（出网加载 jar）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#groovy%E5%87%BA%E7%BD%91%E5%8A%A0%E8%BD%BD-jar)
-   [aspectjtools 读文件（需回显）](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#aspectjtools-%E8%AF%BB%E6%96%87%E4%BB%B6%E9%9C%80%E5%9B%9E%E6%98%BE)
-   [ognl+io 读写文件 / 目录](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#ognl-io-%E8%AF%BB%E5%86%99%E6%96%87%E4%BB%B6-%E7%9B%AE%E5%BD%95)
-   [ajt+xalan+dom4j+io](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#ajt-xalan-dom4j-io)

-   [相关题目](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E7%9B%B8%E5%85%B3%E9%A2%98%E7%9B%AE)
-   [相关工具](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E7%9B%B8%E5%85%B3%E5%B7%A5%E5%85%B7)

-   [FastjsonExpToolkit](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#fastjsonexptoolkit)
-   [JNDI-Exp-MCP](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#jndi-exp-mcp)
-   [其它常用](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%85%B6%E5%AE%83%E5%B8%B8%E7%94%A8)

-   [后记](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%90%8E%E8%AE%B0)
-   [参考](https://www.yuque.com/1diot9/bz9gft/d8736f15d31e343fa6fb42b4062769be#%E5%8F%82%E8%80%83)
...
1、梳理 Fastjson1 反序列化流程，以及 parse / parseObject 的差异  
2、整理探测手段（版本、依赖、期望类）与常见 WAF 绕过  
3、按版本整理关键绕过与利用链（47 / 68 / 80 / 83 等），并简要分析原理  
4、补充「写文件 → RCE」的落地思路，以及配套脚本
...
-   Fastjson 首先调用 **无参构造函数** （ `new ClassName()` ）实例化对象
-   解析 JSON 中的键值对
...
-   从 JSON 里抽出对应构造参数的值
-   调用 **有参构造函数** （ `new ClassName(arg1, arg2...)` ）实例化对象
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/6e4c7e587b07be63.png)

## parse和parseObject

更细的源码分析见： [Fastjson源码分析 | 1diot9's Blog](https://1diot9.github.io/2025/12/04/Fastjson%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90/)

这里先记结论，后面写 payload 时不容易绕晕：

-   `parse` 和多参 `parseObject` （存在期望类） 行为接近，都会调用 setter，以及符合条件的 getter，如下图：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/372c0a33a970336b.png)
...
3、写 jar 覆盖 `jre/lib` ，最经典的是覆盖 `charsets.jar` ；没法写二进制时，可以考虑 ascii jar： [https://github.com/c0ny1/ascii-jar](https://github.com/c0ny1/ascii-jar)  
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/f41c2c32c2afa2fc.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/06ce5a33ace937c3.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/920480522557258c.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/22f982956925d68b.png)

我本地试了好几次一直不行：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/591e5a3c5301a262.png)

## 判断是否存在期望类

[https://mp.weixin.qq.com/s/7c_zi5Pv4a69IV0zzJo5Ww](https://mp.weixin.qq.com/s/7c_zi5Pv4a69IV0zzJo5Ww)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/42d866527fe4e2e4.png)

可以用 java-chains 直接生成：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/751bc50391024a3b.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/eb4d0be3ccef98bf.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/15e03acd28efea4b.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/98e68cfd1ae469f6.png)

可以看到，这个类加载器继承自 `URLClassLoader` ，因此能解析 `jar` 、 `http` 这类协议。

跟进 `getResourceAsStream` ：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/1c16aec98303a05c.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/a5e7ea34a53367fc.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/b5fbb35a6f4c177e.png)

接着回到 `checkAutoType` 。此时会走 Fastjson 自写的 asm 机制，检查拿到的类有没有 `@JSONType` ：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/f85685c9afc2e6bc.png)

类上带注解时，就会直接进入 `TypeUtils.loadClass` ，效果接近开启了 `autoTypeSupport` ，而且还开了类缓存，后面可以反复触发。

跟进到 `loadClass` ：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/7c8b88635c232337.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/189a18548cea477a.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/582cfe98a53027e8.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/c7ebe30871748818.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/fb0a0c85fddfde93.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/bea8390e083056ca.png)

说明 `defineClass` 的 JNI native 代码里，会把点号换成斜杠，这也和上面 JVM 类名字符集范围的结论对得上。

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/a23c58138bb05898.png)

至此，jar 里那个类名很怪的恶意类就成功进 JVM 了，并且被 Fastjson 缓存：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/543de73a585c35b1.png)

最终在这个方法里触发类初始化：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/8fcf4729d9b08b0a.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/036594fbb9ec7de3.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/7df3d69bad59afba.png)

可以看到，这里传入的 loader 其实还是 `LaunchedURLClassLoader` ，理论上能加载 name 里 `jar:http` 对应的资源，因为 `forName` 最终还是走 `loader.loadClass` 。

再跟一步：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/8fab43654d9c3829.png)

能发现是在 `forName0` 这个 native 层报错了。

原因是： `forName0` 不允许类名里出现双斜杠，而我们的 `http://` 里就有双斜杠，所以加载失败。

具体 native 调用如下（ [https://github.com/openjdk/jdk/blob/jdk8-b120/jdk/src/share/native/java/lang/Class.c）：](https://github.com/openjdk/jdk/blob/jdk8-b120/jdk/src/share/native/java/lang/Class.c%EF%BC%89%EF%BC%9A)

`Java_java_lang_Class_forName0` → `VerifyClassname` → `skip_over_fieldname`

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/d6d2619260c13c58.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/aa816ce5675849cf.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/7bd4b0a6a5f093e8.png)

只有 `getResourceAsStream` 那里不一样：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/c379e37eb0f58cbc.png)
...
[https://github.com/1diot9/MyJavaSecStudy/blob/main/fastjson/fastjson/fastj-1.2.83/cve-2026-16723/poc_fd_cache_writefile.py](https://github.com/1diot9/MyJavaSecStudy/blob/main/fastjson/fastjson/fastj-1.2.83/cve-2026-16723/poc_fd_cache_writefile.py)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/b91b04e251150c33.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/81678a0fe53220c1.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/6b84923f6f15d5ae.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/65bdb9b54e9c021c.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/3f9e08748c629ecc.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/a1de8f50fc114cd9.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/14abc80221613d7f.png)

## 修复分析

默认不缓存：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/d683a2154fb44afa.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/02c1a0b04ee8a8ec.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/f84043336bd5780b.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/de2d1954decbd204.png)

## 修复分析

`AutoCloseable` 进黑名单，不再作为 expectClass：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/6a537f7837d9120b.png)
...
这里io1-io6，主要参考的是珂技知识分析公众号里的文章：  
[https://mp.weixin.qq.com/s/n8RW0NIllcQ0sn3nI9uceA](https://mp.weixin.qq.com/s/n8RW0NIllcQ0sn3nI9uceA)

### commons-io 版本差异

[http://www.bmth666.cn/2025/12/30/Fastjson-commons-io%E4%BB%BB%E6%84%8F%E6%96%87%E4%BB%B6%E8%AF%BB%E5%86%99/](http://www.bmth666.cn/2025/12/30/Fastjson-commons-io%E4%BB%BB%E6%84%8F%E6%96%87%E4%BB%B6%E8%AF%BB%E5%86%99/)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/7406c454d424b4a8.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/afc9a5fd7ddcc714.png)

想调 String 的构造，还是报错。

换成正确 payload 跟进调试，最终发现是在这里截取：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/85def2ba16becb44.png)

然后在 `StringCodec` 里正式取出：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/1a0093b365750bce.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/d796ad9c1a2f26a7.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/2b67e77a94ef7443.png)

总的来说，记住有这么一种写法即可。

### io3 写文件（≈ io1 / io2）

su18 发现的类似 io1 的链，和 io1 基本一样：  
...
[https://www.geekcon.top/js/pdfjs/web/viewer.html?file=/doc/ppt/GC24_SpringBoot%E4%B9%8B%E6%AE%87.pdf](https://www.geekcon.top/js/pdfjs/web/viewer.html?file=/doc/ppt/GC24_SpringBoot%E4%B9%8B%E6%AE%87.pdf)
...
前面 io1～io7 各有取舍：io1/io2 靠 `XmlStreamReader` 触发、卡 8kb；io6 换成 `LockableFileWriter` 突破大小和建目录，但仍要 `XmlStreamReader` ；io7 能写任意长度二进制，有期望类时再套 Currency，但 Currency 那条 **结果一定报错**，没回显细节时很难判断是不是 payload 本身写挂了。

ioFinal 相当于把优点收拢一遍，推荐用 java-chains 直接生成：

1、触发改为 `"$ref":"$.bOM"` ，直接打到 `BOMInputStream.getBOM` ，不再绕 `XmlStreamReader` 构造  
2、输入侧用 `CharSequenceReader` + `ReaderInputStream` ，内容用 `\x..` + `iso-8859-1` 塞二进制，比 io7 的 `CharSequenceInputStream` 更好控，也少踩一些 commons-io 版本构造差异  
3、写出侧继续 `LockableFileWriter` ，并可带 `lockDir` 自动建目录；任意长度，不卡 8kb  
4、无期望类的 `parse` 点可直接用，不必套 Currency，也就不会「必报错」干扰判断；若点上确实有期望类，再按前文小技巧套一层 Currency 即可
...
[https://1diot9.github.io/2025/05/05/mysql-JDBC-%E7%BB%95%E8%BF%87/](https://1diot9.github.io/2025/05/05/mysql-JDBC-%E7%BB%95%E8%BF%87/)
...
\[[https://changeyourway.github.io/2025/08/23/Java%20%E5%AE%89%E5%85%A8/%E6%BC%8F%E6%B4%9E%E7%AF%87-Fastjson%201.2.68-1.2.80%20%E5%88%A9%E7%94%A8/#%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90\]](https://changeyourway.github.io/2025/08/23/Java%20%E5%AE%89%E5%85%A8/%E6%BC%8F%E6%B4%9E%E7%AF%87-Fastjson%201.2.68-1.2.80%20%E5%88%A9%E7%94%A8/#%E6%BA%90%E7%A0%81%E5%88%86%E6%9E%90]) ([https://changeyourway.github.io/2025/08/23/Java](https://changeyourway.github.io/2025/08/23/Java) 安全/漏洞篇-Fastjson 1.2.68-1.2.80 利用/#源码分析)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/cb25fc315427e0b4.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/be20e1e821be817f.png)

把类型和反序列化器放进 Map。

`checkAutoType` 里很早就取：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/5a8c44ef650518e2.png)

而 Exception 类型的反序列化器 `ThrowableDeserializer` ，在 80 版本有这么一行：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/01065180294416d6.png)

这里会解析其他键值对；当 value 和实际字段类型不符时会走 `cast` ，于是类里的属性也会进缓存——因为最后同样会调 `config.getDeserializer` ，和前面说的一样：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/64b9579874515b93.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/b648ce080f630d01.png)
...
[https://github.com/kezibei/fastjson_payload/blob/main/web.py](https://github.com/kezibei/fastjson_payload/blob/main/web.py) 出网脚本
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/f1c5c54a1802cc80.png)

推荐用 java-chains 生成：

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/c63fb2211f41d29c.png)

![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/196392797e76b2eb.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/f19b22e383adfe86.png)
...
![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/6b9e3bae8058bee2.png)
...
[https://github.com/kezibei/fastjson_payload/blob/main/src/test/Fastjson22_ognl_io_read_error_dnslog.java](https://github.com/kezibei/fastjson_payload/blob/main/src/test/Fastjson22_ognl_io_read_error_dnslog.java)
...
[https://github.com/kezibei/fastjson_payload/blob/main/src/test/Fastjson21_ajt_xalan_dom4j_io_read_httplog.java](https://github.com/kezibei/fastjson_payload/blob/main/src/test/Fastjson21_ajt_xalan_dom4j_io_read_httplog.java)

这些依赖组合起来比较少见，也许会在某些框架项目里碰到。受限于笔者知识，这里不深入了。

后面还有一系列不需要 ajt 依赖的：

[https://github.com/kezibei/fastjson_payload/blob/main/src/test/Fastjson27_xalan_dom4j_io_read_error_dnslog.java](https://github.com/kezibei/fastjson_payload/blob/main/src/test/Fastjson27_xalan_dom4j_io_read_error_dnslog.java)

## 相关题目

[https://github.com/luelueking/CVE-2022-25845-In-Spring](https://github.com/luelueking/CVE-2022-25845-In-Spring)

\[[https://github.com/cwkiller/Java-Puzzle/tree/main/Fastjson%20Decoder\]](https://github.com/cwkiller/Java-Puzzle/tree/main/Fastjson%20Decoder]) ([https://github.com/cwkiller/Java-Puzzle/tree/main/Fastjson](https://github.com/cwkiller/Java-Puzzle/tree/main/Fastjson) Decoder)

[https://github.com/1diot9/CTFJavaChallenge/tree/main/2025/%E4%BA%AC%E9%BA%92CTF](https://github.com/1diot9/CTFJavaChallenge/tree/main/2025/%E4%BA%AC%E9%BA%92CTF)

[https://mp.weixin.qq.com/s/GEGPpQ_1nflO_w4cefB-xA](https://mp.weixin.qq.com/s/GEGPpQ_1nflO_w4cefB-xA)

[http://www.bmth666.cn/2022/10/19/Fastjson%E9%AB%98%E7%89%88%E6%9C%AC%E7%9A%84%E5%A5%87%E6%8A%80%E6%B7%AB%E5%B7%A7/](http://www.bmth666.cn/2022/10/19/Fastjson%E9%AB%98%E7%89%88%E6%9C%AC%E7%9A%84%E5%A5%87%E6%8A%80%E6%B7%AB%E5%B7%A7/)

[https://flowerwind.github.io/2025/02/28/%E5%88%86%E4%BA%AB%E4%B8%80%E6%AC%A1%E7%BB%84%E5%90%88%E6%BC%8F%E6%B4%9E%E6%8C%96%E6%8E%98%E6%8B%BF%E4%B8%8B%E7%9B%AE%E6%A0%87/](https://flowerwind.github.io/2025/02/28/%E5%88%86%E4%BA%AB%E4%B8%80%E6%AC%A1%E7%BB%84%E5%90%88%E6%BC%8F%E6%B4%9E%E6%8C%96%E6%8E%98%E6%8B%BF%E4%B8%8B%E7%9B%AE%E6%A0%87/) 83版本，配合其他写文件漏洞，也能getshell

[https://1diot9.github.io/2026/02/18/%E4%BA%AC%E9%BA%92CTF25-FastJ/](https://1diot9.github.io/2026/02/18/%E4%BA%AC%E9%BA%92CTF25-FastJ/) JDK11写文件漏洞在80版本的特殊利用
...
1、 `detect_pipeline` ：识别 → 版本 → 期望类  
2、 `deps_probe` ：依赖 / classpath 探测（Character 报错回显，可降级 Class MiscCodec，也可走 DNS）  
3、 `poc_catalog` / `poc_run` / `poc_script` ：按版本列 gadget、生成或发送 PoC，复杂逻辑可取原脚本自己改  
4、 `docs_list` / `docs_get` ：内置探测与各版本分析文档  
5、Web 端还有 `/detect` 、 `/poc` 、 `/waf` 、 `/lab` 等页面，以及 Docker 靶场启停
...
[Fastjson高版本的奇技淫巧](http://www.bmth666.cn/2022/10/19/Fastjson%E9%AB%98%E7%89%88%E6%9C%AC%E7%9A%84%E5%A5%87%E6%8A%80%E6%B7%AB%E5%B7%A7/index.html)
...
[Fastjson commons-io任意文件读写](http://www.bmth666.cn/2025/12/30/Fastjson-commons-io%E4%BB%BB%E6%84%8F%E6%96%87%E4%BB%B6%E8%AF%BB%E5%86%99/index.html)
