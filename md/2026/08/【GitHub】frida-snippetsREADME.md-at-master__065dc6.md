---
title: 【GitHub】frida-snippets/README.md at master
source: https://github.com/iddoeldor/frida-snippets/blob/master/README.md
source_host: github.com
clip_date: 2026-08-14T17:27:38+08:00
trace_id: 2e59536d-0f73-4012-88ae-30cd6bac0d57
content_hash: c1e45994a405c3a723a4d949aea337e248d7fff02e9f5139f71e7af54e14aa1e
status: synced
tags:
  - GitHub
  - Frida
...
series: null
feed_source: null
ai_summary: Frida 逆向速查手册，汇总 Native/Android/iOS 常用 Hook、内存扫描、Binder、SSL 密钥抓取等脚本及编辑器集成片段。
ai_summary_style: key-points
images_status:
  total: 3
  succeeded: 3
  failed_urls: []
notion_page_id: 3bc75244-d011-81d5-b2c2-e86a8ae1d629
ioc: null
---

> 💡 **AI 总结（key-points）**
>
> Frida 逆向速查手册，汇总 Native/Android/iOS 常用 Hook、内存扫描、Binder、SSL 密钥抓取等脚本及编辑器集成片段。
> 
> - **仓库定位：** 收录跨平台 Frida 实用代码片段，按 Native、Android、iOS 平台分类，并给出 Sublime/Vim/JEB 的自动补全或生成脚本。
> - **常用 Hook：** 提供拦截 libc open/read、socket 收发、SQLite 查询、系统属性读取、Binder ioctl 等示例，均带可运行代码与输出日志。
> - **SSL 密钥抓取：** iOS 上拦截 SSL_CTX_set_info_callback 并按系统版本写入 0x2A8/0x2B8 偏移回调；Android 上拦截 SSL_CTX_new 后调用 SSL_CTX_set_keylog_callback，导出 TLS key log。
> - **反混淆与早期 Hook：** 通过拦截 RegisterNatives 可还原手动注册的 JNI 符号；利用 linker64 的 do_dlopen/call_constructor 在 DT_INIT_ARRAY 前挂接目标库。
> - **调试辅助：** 单次 watchpoint 用 mprotect 移除内存权限触发异常并解析调用栈；Stalker 可按地址范围逐指令跟踪并打印寄存器代换后的指令；还包含 dump 内存段与内存扫描片段。

[![PRs Welcome](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/4efc9795006c7646.svg)](https://camo.githubusercontent.com/25b3e6d0d42c98de74a98cbb4d149a1c09020cf6d1361993b72d7d5b8ffed363/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f5052732d77656c636f6d652d627269676874677265656e2e7376673f7374796c653d666c61742d737175617265) & also output examples
...
[![HAHAHA. No.](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/06fdea8e7d5cf171.jpg)](https://camo.githubusercontent.com/a45c1caecac10d7845ddd090cc9a4563924604c9639dc30bf05dbd9bd9c21730/68747470733a2f2f692e6b796d2d63646e2e636f6d2f70686f746f732f696d616765732f6f726967696e616c2f3030302f3535312f3835342f3036662e6a7067)
...
-   [https://frida.re/docs/javascript-api/#cmodule](https://frida.re/docs/javascript-api/#cmodule)
-   [https://frida.re/news/2019/09/18/frida-12-7-released/](https://frida.re/news/2019/09/18/frida-12-7-released/)
...
Output example Intecepting \`com.android.chrome\`

[![](https://cdn.jsdelivr.net/gh/zhiyu-zeng/img@main/img/2026/08/f73469265259f236.gif)](https://github.com/iddoeldor/frida-snippets/blob/master/gif/intercept_open_chrome_android.gif)
...
`registerNativeMethods` can be used as anti reversing technique to the native.so libraries, e.g. hiding the symbols as much as possible, obfuscating the exported symbols and eventually adding some protection over the JNI bridge. [source](https://stackoverflow.com/questions/51811348/find-manually-registered-obfuscated-native-function-address)
...
Output example [https://stackoverflow.com/a/54818023/2655092](https://stackoverflow.com/a/54818023/2655092)
...
Output example \`\`\`js { "key1": "value 1", "key2": "value 2" } \`\`\`
...
Output example mul x5, x2, x21 # mul 0x3, 0x4, 0x5
